<template>
    <div class="flex justify-center items-center min-h-screen bg-yellow-100">
      <div class="container mx-auto p-14 bg-white rounded-lg shadow-lg border border-black-300 bg-blue">
        <h1 class="text-5xl text-center text-gray-800 mb-10 oten">Expense Tracker ni dane</h1>
        <div class="flex">
                <div class="flex-1 mr-12 max-w-lg oten">
          ...
          <div class="flex-1 relative oten"> 
